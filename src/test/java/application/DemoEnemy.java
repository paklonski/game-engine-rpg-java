...
/**
 * A shortened version of the Enemy.java class without a one line of the code
 * to update the game field. 
 * Created for a unit testing of methods of the class Enemy.java.
...
public class DemoEnemy {
    ...
    /**
     * Look for the enemy and redraw the map array.
     */
    public void move() {
