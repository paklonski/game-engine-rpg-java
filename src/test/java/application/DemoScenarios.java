...
/**
 * An almost full version of the Scenarios.java class without lines of the code
 * that call methods which draw images onto the game panel,
 * perform any operations with images and create new windows.
...
public class DemoScenarios {
     ...
     * @param radius the radius of neighbor searching
     */
